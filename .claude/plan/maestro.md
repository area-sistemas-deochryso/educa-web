...
| 13 | BAudit2 | Audit F1 | Bugs críticos de fugas/reliability — brief [663](../chats/open/663-audit-f1-bugs-criticos-fugas-reliability.md) | libre |
...
- **`running/`**: vacío · **`open/`**: 5 briefs (658, 663, 664, 665, 666) — al cap soft de backlog-hygiene (≤5) · **`awaiting-prod/`**: 2 briefs (462, 578) · **`waiting/`**: vacío · **`troubles/`**: vacío
