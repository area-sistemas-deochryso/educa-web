...
- **Plan 45 F2.2 FE — UI rework `/incidencias/errores`** — JOIN endpoint `/full` + vista por evento `ErrorLog` + tab Trace real. Bloqueado por F5 BE. Sub-plan en [`educa-coord/plans/xrepo-45-monitoreo-incidencias-rework.md`](../../../educa-coord/plans/xrepo-45-monitoreo-incidencias-rework.md) §F2. F2.1 ✅ verificado 2026-05-19 (brief 197 closed).

### 🗄️ Cerrados desde último saneamiento (2026-05-19 → 2026-05-22)

- ~~F-021 (brief `199`)~~ ✅ implementado 2026-05-19, en awaiting-prod.
- ~~F-022 (brief `200`)~~ ✅ closed 2026-05-19, falso positivo / wontfix.
- ~~Brújula W21~~ ✅ cerrada 2026-05-19 (6/6 briefs closed, deuda residual en `tasks/polish-post-W21-grades-dialogs-sync.md`).
...
8 briefs en `awaiting-prod/` (actualizado 2026-05-22):
...
- `147` — Plan 43 Chat 2.1 FE: badge transiente + textarea blacklist + link auditoría (G.3 → F-021 brief `199`)
- `169` — Plan 43 Chat 3.1b FE: SMTP response en drawers monitoreo (blacklist OK, quarantine sin data prod)
- `199` — F-021: deep-link `/intranet/admin/usuarios?dni=X&autoOpen=true` (implementado 2026-05-19)
- `213` — Fix FE: pre-login cookie cleanup + error handling hardening

### Notas operativas

- **Chat activo en `running/`**: ninguno.
- **Saneamiento de cola 2026-05-22** — limpieza de items completados en Pullable (F-021 awaiting-prod, F-022 closed, Brújula W21 cerrada). Agregado brief 216 (xrepo-50 F1). Plan 45 F2.2 movido a Future (bloqueado por BE). Lista awaiting-prod reconciliada con filesystem (8 briefs). Narrativa de Cowork 2026-05-19 archivada (detalle en [`claude-cowork/reporte-cowork-2026-05-19.md`](../claude-cowork/reporte-cowork-2026-05-19.md)).
