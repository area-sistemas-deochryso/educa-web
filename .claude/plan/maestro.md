...
- **F-021 (brief `199`) — Deep-link `usuarios?dni=X&autoOpen=true`** 🟠 Cowork 2026-05-19. Reabre brief 147 G.3. Severidad Alto. FE puro, sin BE. Sugerencia y reproducción en el brief.
