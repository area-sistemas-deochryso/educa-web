...
| 0.11 | BAudit3 | Audit Tests F2 | Bugs de aserción — 7 specs cuyo assert no verifica lo que promete — brief [690](../chats/open/690-audit-tests-f2-bugs-asserts-debiles.md) | local | libre |
| 0.12 | BAudit3 | Audit Tests F3 | Cobertura de mutaciones críticas de seguridad/aprobación (permisos por usuario sin spec, aprobación salones, grupos+rollback, contacto público) — brief [691](../chats/open/691-audit-tests-f3-cobertura-seguridad-mutaciones-criticas.md) | local | libre |
...
| 0.14 | BAudit3 | Audit Tests F5 | Gaps infra WAL/integration (timers, `httpMock.verify()`, wal-leader, notifications.service) — brief [693](../chats/open/693-audit-tests-f5-infra-wal-integration-gaps.md) | local | libre |
| 0.15 | BAudit3 | Audit Tests F6 | Inconsistencias transversales de tests (batch housekeeping) — brief [694](../chats/open/694-audit-tests-f6-inconsistencias-transversales.md) | local | libre |
