...
- [~] **F2 — B + C (multiplier por rol + modifier por endpoint)** (2 chats, BE) — **Chat 1 ✅ cerrado 2026-04-22 (máquina del multiplier). Chat 2 ⏳ aplicar overrides a 14+2 endpoints.**
