...
| BAudit2 | Auditoría buenas prácticas Angular 22/TS 6.0 | F1-F4 briefs abiertos (663-666) · F5-F12 en backlog del plan | 🟡 |
...
| 14 | BAudit2 | Audit F2 | Seguridad — password plaintext en `users/` — brief [664](../chats/open/664-audit-f2-seguridad-password-plaintext-users.md) | libre |
