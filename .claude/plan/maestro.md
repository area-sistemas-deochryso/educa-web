...
2. **[Plan 37 · Chat 1 · `Educa.API` · BE]** — extender el parser bounce con tipos de evento adicionales. Brief en `.claude/chats/open/066-plan-37-chat-1-be-parser-extension-defer-events.md`. **Bloqueado 48h** post-deploy del Plan 31 Chat 2b (069 `awaiting-prod/`) para no contaminar telemetría inicial — desbloqueable ~2026-04-30.
