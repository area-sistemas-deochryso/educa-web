...
| BAudit2 | Auditoría buenas prácticas Angular 22/TS 6.0 | F1 ✅ · F2 FE ✅ awaiting-prod (664) — BE handoff pendiente (`Educa.API` brief 667) · F3-F4 briefs abiertos (665-666) · F5-F12 en backlog del plan | 🟡 |
...
| 15 | BAudit2 | Audit F3 | Race conditions en fetches (~9 facades) — brief [665](../chats/open/665-audit-f3-race-conditions-fetches-sin-cancelacion.md) | libre |
