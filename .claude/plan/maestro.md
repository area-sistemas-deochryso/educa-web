...
**Siguiente accionable**: **BAudit2 F6** (Tier 0, pos 0.3) — config zoneless explícita, brief [680](../chats/open/680-audit-f6-zoneless-config-explicita.md). Tier 0 reordenado 2026-09-12 a pedido explícito del usuario para priorizar el resto del audit Angular 22/TS 6.0 (F4-F12) por sobre xP41. Audit F4 (666, pos 0.1) ✅ cerrado (9/9 fixes). Audit F5 (679, pos 0.2) ✅ cerrado, awaiting-prod. xP41 F3 BE (persist request lifecycle) queda como siguiente tras cerrar Tier 0. Admin block cerrado (P62-P66 ✅/descartado). P50 F3a ✅ (331 closed).
