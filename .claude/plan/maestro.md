...
8. **[Plan 37 · Chat 3 · `educa-web` · FE]** — visibilidad admin de cuarentena en `/intranet/admin/email-outbox`. Brief en `.claude/chats/open/068-plan-37-chat-3-fe-quarantine-admin-visibility.md`. Depende del Chat 2.
