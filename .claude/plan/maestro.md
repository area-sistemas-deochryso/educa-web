...
#### Plan 22 — Endurecimiento correos de asistencia 🟢 (plan file 2026-04-21 · Chat 1 + Chat 2 + Chat 3 F3.BE cerrados 2026-04-21 · pendiente Chat 4 F3.FE en este repo)
...
> **Estado**: plan file creado 2026-04-21 con desglose de 6 chats atómicos (4 BE + 2 FE). Secuencia sugerida F1 → F2 → F3.BE → F3.FE → F4.BE → F4.FE. Chat 1 (F1) + Chat 2 (F2) + Chat 3 (F3.BE) cerrados 2026-04-21. **Próximo**: Chat 4 (F3.FE) en `educa-web` — UI admin `/admin/email-outbox` con badge `TipoFallo` + filtro + `disabled` en "Reintentar" para tipos permanentes.
