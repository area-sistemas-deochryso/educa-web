...
1. **[Plan 38 · Chat 6 · `Educa.API`+`educa-web` · BE+FE]** — `EmailHub` SignalR + banner B9 + toast cuando `defer-fail-status >= 4/5` o `MailboxFullBlacklistHandler` dispara. Brief en `.claude/chats/open/076-plan-38-chat-6-fe-banner-b9-toast-signalr.md`. Depende de Chat 5 mergeado + Plan 37 Chat 3 (068).
