...
5. **[Plan 39 · Chat E · `Educa.API` · BE]** 🔒 **HOLD** — `ExpiredEximLogImportJob` (importador SSH logs Exim). Brief en `.claude/chats/open/081-plan-39-chat-e-be-importador-ssh-exim-logs.md` con flag `<!-- on-hold-criteria-pending -->`. Criterios reactivación documentados (Plan 38 captura <80% / OPS aprueba SSH / 2+ incidentes en trimestre). NO-GO definitivo si en 90d ningún criterio dispara.
