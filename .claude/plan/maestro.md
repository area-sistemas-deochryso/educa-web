...
| xP107 | → Entorno de desarrollo orientado a pruebas (coord P107) | F1 FE — brief [618](../chats/running/618-fe-p107-f1-test-tools-surface.md) en `running/` (worktree `chat/618-fe-p107-f1-test-tools-surface`). Corre en paralelo con F1 BE (Educa.API, brief 617) | ver P107 |
