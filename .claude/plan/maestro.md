...
> **Plan 28 Chat 5 docs ✅ ship 2026-05-07** (brief 129) — INV-AD08/AD09 formalizados + INV-AD05/06 ampliados + §1.1/§15.4/§17 actualizados. Plan 28 docs al 100%. Falta deploy + Chat 3c + Chat 4 FE para 100% funcional. Chat 6 BE gap-fix opcional (autorización condicional INV-AD08, patrón Plan 27) reservado.
