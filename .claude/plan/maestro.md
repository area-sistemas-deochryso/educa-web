...
2. **[Plan 37 · Chat 2 · `Educa.API` · BE]** — cuarentena temporal + pause por dominio receptor consumiendo `EmailDeferEvent` del Chat 1. Brief en `.claude/chats/open/067-plan-37-chat-2-be-quarantine-domain-pause.md`. **Desbloqueable** tras verify de 066 + 069 (telemetría real entrando a `EmailDeferEvent`).
3. **[Plan 37 · Chat 3 · `educa-web` · FE]** — visibilidad admin de cuarentena en `/intranet/admin/email-outbox`. Brief en `.claude/chats/open/068-plan-37-chat-3-fe-quarantine-admin-visibility.md`. Depende del Chat 2.
