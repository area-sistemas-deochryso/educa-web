...
> **Fecha**: 2026-04-14 (última revisión: 2026-04-22, **Plan 27 Chat 5 cierre docs ✅ cerrado** — `INV-C11` formalizado en `business-rules.md §1.11 + §15.4`, 1155 BE + 1507 FE tests verdes. **Pendiente solo validación del jefe post-deploy** para declarar Plan 27 100% archivable)
...
> **Estado**: 🟢 **Chats 1-5 ✅ cerrados 2026-04-22** — diseño + BE + FE + documentación formal completos. Chat 4 incluyó BE mínimo (`GraOrden` en DTOs self-service, commit `a967e21`, 1155 verdes) + FE completo (scope constants + banner admin + per-student notice + widget home verificado, commit `3c5061e`, 1507 verdes). Chat 5 formalizó `INV-C11` en `business-rules.md §1.11` (nueva subsección "Filtro temporal por grado") + fila en §15.4 "Invariantes de Cálculo". **Solo pendiente validación del jefe post-deploy** para archivar el plan en `history/planes-cerrados.md`.
