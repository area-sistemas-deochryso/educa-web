...
- **`running/`**: vacío · **`open/`**: 8 briefs (658, 680-686) — **excede intencionalmente** el soft cap de `backlog-hygiene.md` (≤5): generación completa de briefs del audit FE a pedido explícito del usuario 2026-09-12, excepción documentada para fases de audit deliberadamente pesadas · **`awaiting-prod/`**: 5 briefs (462, 578, 664, 665, 679) · **`waiting/`**: vacío · **`troubles/`**: vacío
