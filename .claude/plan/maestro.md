...
2. **[Plan 28 · Chat 3 · `Educa.API` · BE]** — Reportes PDF/Excel + correos + bandeja + notificaciones para Asistentes Administrativos (`TipoPersona='A'`). **Razón**: Chat 2 BE (modelo + dispatch) ya cerró 2026-04-22; bloqueador "validación jefe Plan 27" ya levantado (Plan 27 cerrado). Es la siguiente fase natural y desbloquea Chat 4 FE.
