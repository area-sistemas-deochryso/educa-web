...
1. **[Plan 24 · Chat 4 · `Educa.API` · BE]** — Validar rate limit real + revisar `Task.Delay(30000)` entre páginas (si CrossChex soporta bajar a 5-10s, gran acelerador percibido) + deploy BE+FE. **Último chat del Plan 24** — cierra el feature.
