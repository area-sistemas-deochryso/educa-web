...
> **Para estructura recomendada por componente** (stat card, tabla, filter bar, dialogs, drawers, alert banners): ver `reference/design-system.md` sección 7 (pautas B1-B11). Esta regla cubre cómo importar y configurar PrimeNG; el design-system cubre cómo ensamblar los componentes en páginas consistentes.
