...
> **Validación prod**: ✅ verificada 2026-04-28 — ruta `/intranet/admin/monitoreo/correos/auditoria` carga, universo activo pasa validador (0 inválidos), filtros y tabla operativos.
