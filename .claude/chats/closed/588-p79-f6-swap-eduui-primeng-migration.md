...
> **Plan**: 79 (coord, `xrepo-79-primeng-replacement-library.md`) · **Fase**: F6 · **Creado**: 2026-08-22 · **Estado**: ✅ cerrado (2026-08-25) → `awaiting-prod`, lint/build/tests verdes localmente. **Validación prod**: ✅ verificada 2026-09-08 — smoke test visual en `educa.com.pe/intranet` (`/admin/cursos`, claro/oscuro): dialog "Editar Curso" con header/footer y botones Guardar/Cancelar renderizando correctamente, tablas OK en dark mode.
>
