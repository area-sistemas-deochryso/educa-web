...
export type EduMessageSeverity = 'info' | 'success' | 'warn' | 'danger' | 'secondary' | 'contrast';
...
@Component({
	...
	styles: `
		...
		.edu-message[data-severity='danger'] { background: color-mix(in srgb, var(--eduui-red-50), transparent 5%); border-color: var(--eduui-red-200); color: var(--eduui-red-600); }
		...
		:host-context(.dark-mode) {
			...
			.edu-message[data-severity='danger'] { background: color-mix(in srgb, var(--eduui-red-500), transparent 84%); border-color: color-mix(in srgb, var(--eduui-red-700), transparent 64%); color: var(--eduui-red-500); }
