...
import { EstudianteAsistenciaApiService } from './estudiante-asistencia-api.service';
import { ApoderadoAsistenciaApiService } from './apoderado-asistencia-api.service';
import { ProfesorAsistenciaApiService } from './profesor-asistencia-api.service';
import { DirectorAsistenciaApiService } from './director-asistencia-api.service';

/**
 * Thin facade that delegates to role-specific API services.
 * Kept for backward compatibility — existing consumers can continue
 * injecting AsistenciaService without changes.
 *
 * New code should inject the role-specific services directly:
 * - EstudianteAsistenciaApiService
 * - ApoderadoAsistenciaApiService
...
export class AsistenciaService {
	...
	private readonly estudianteApi = inject(EstudianteAsistenciaApiService);
	private readonly apoderadoApi = inject(ApoderadoAsistenciaApiService);
