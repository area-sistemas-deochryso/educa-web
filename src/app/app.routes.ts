...
export const routes: Routes = [
	{
		path: 'intranet',
		loadChildren: () =>
			import('./views/intranet/intranet.routes').then((m) => m.INTRANET_ROUTES),
	},
	{
		path: '',
		loadComponent: () =>
		...
		children: [
			...
			},
			{
				path: 'contacto',
				loadComponent: () =>
					import('./views/contact/contact').then((m) => m.ContactComponent),
			...
			},
			{
				...
				loadComponent: () =>
					import('./views/levels/inicial/inicial').then((m) => m.InicialComponent),
				title: 'Educa.com.pe - Nivel Inicial',
			},
			{
				path: 'niveles/primaria',
				loadComponent: () =>
					import('./views/levels/primaria/primaria').then((m) => m.PrimariaComponent),
			...
			},
			{
				path: 'privacidad',
				loadComponent: () =>
					import('./views/privacy/privacy').then((m) => m.PrivacyComponent),
