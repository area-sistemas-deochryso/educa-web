...
describe('permissionsGuard', () => {
	...
	let accessDeniedMock: Partial<AccessDeniedService>;
	...
	beforeEach(() => {
		...
		TestBed.configureTestingModule({
			providers: [
				...
				{ provide: AccessDeniedService, useValue: accessDeniedMock },
			],
		});
	});
	...
	describe('access denied', () => {
		it('should redirect to /intranet and show warning', async () => {
			...
			expect(accessDeniedMock.show).toHaveBeenCalledWith('intranet/admin/salones');
		});
	});
	// #endregion
