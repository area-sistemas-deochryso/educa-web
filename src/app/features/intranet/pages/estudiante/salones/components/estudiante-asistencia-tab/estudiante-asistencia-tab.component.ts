...
@Component({
	selector: 'app-estudiante-asistencia-tab',
	standalone: true,
	imports: [CommonModule, FormsModule, TableModule, TagModule, SelectModule],
	changeDetection: ChangeDetectionStrategy.OnPush,
	templateUrl: './estudiante-asistencia-tab.component.html',
	styleUrl: './estudiante-asistencia-tab.component.scss',
})
export class EstudianteAsistenciaTabComponent implements OnInit {
