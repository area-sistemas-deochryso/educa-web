// * Tests for StudentSchedulesStore — validates simple schedule state.
// #region Imports
...
// #region Tests
describe('StudentSchedulesStore', () => {
	let store: StudentSchedulesStore;

	beforeEach(() => {
		TestBed.configureTestingModule({ providers: [StudentSchedulesStore] });
