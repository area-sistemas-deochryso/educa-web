...
export class SchedulesStore {
	...
	readonly dataVm = computed(() => ({
		...
		entityWeeklyBlocks: this.filterStore.entityWeeklyBlocks(),
		salonEntities: this.filterStore.salonEntities(),
		profesorEntities: this.filterStore.profesorEntities(),
		selectedEntityId: this.filterStore.selectedEntityId(),
		contextSalonId: this.filterStore.contextSalonId(),
