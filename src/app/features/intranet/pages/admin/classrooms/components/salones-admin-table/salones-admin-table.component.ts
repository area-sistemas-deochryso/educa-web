...
import { EduSortableColumn, EduTable, EduTag, EduTooltip } from '@edu-ui';

@Component({
	selector: 'app-classrooms-admin-table',
	standalone: true,
	imports: [CommonModule, EduTable, ButtonModule, EduTag, ModoAsignacionBadgeComponent, EduTooltip, EduSortableColumn],
