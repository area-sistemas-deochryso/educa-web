// * Tests for SalonesAdminStore — validates salon management state.
// #region Imports
...
// #region Tests
describe('SalonesAdminStore', () => {
	let store: SalonesAdminStore;

	beforeEach(() => {
		TestBed.configureTestingModule({
			providers: [SalonesAdminStore],
		});
		store = TestBed.inject(SalonesAdminStore);
	});
