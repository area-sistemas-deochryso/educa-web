// * Tests for ProfesorFinalSalonesStore — validates professor final grades state.
// #region Imports
...
// #region Tests
describe('ProfesorFinalSalonesStore', () => {
	let store: ProfesorFinalSalonesStore;

	beforeEach(() => {
		TestBed.configureTestingModule({ providers: [ProfesorFinalSalonesStore] });
