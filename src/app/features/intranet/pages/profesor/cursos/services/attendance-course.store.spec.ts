// * Tests for AttendanceCourseStore — validates attendance registration state.
// #region Imports
...
// #region Tests
describe('AttendanceCourseStore', () => {
	let store: AttendanceCourseStore;

	beforeEach(() => {
		TestBed.configureTestingModule({ providers: [AttendanceCourseStore] });
