...
@Component({
	selector: 'app-asistencia-resumen-panel',
	standalone: true,
	imports: [CommonModule, FormsModule, ButtonModule, DatePickerModule, TableModule, TagModule],
	changeDetection: ChangeDetectionStrategy.OnPush,
	templateUrl: './asistencia-resumen-panel.component.html',
	styleUrl: './asistencia-resumen-panel.component.scss',
})
export class AsistenciaResumenPanelComponent {
	// #region Inputs
