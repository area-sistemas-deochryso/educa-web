...
export const MENU_ITEMS: MenuItemDef[] = [
	...
	{ route: '/intranet/admin/email-outbox/dashboard-dia', label: 'Dashboard del día', icon: 'pi pi-chart-bar', permiso: PERMISOS.ADMIN_EMAIL_OUTBOX_DASHBOARD_DIA, modulo: 'sistema', featureFlag: 'emailOutboxDashboardDia', group: { label: 'Monitoreo', icon: 'pi pi-chart-bar' }, preview: 'admin-table', description: 'Snapshot diario de envíos, fallos y bounces' },
	{ route: '/intranet/admin/email-outbox/diagnostico', label: 'Diagnóstico', icon: 'pi pi-search', permiso: PERMISOS.ADMIN_EMAIL_OUTBOX_DIAGNOSTICO, modulo: 'sistema', featureFlag: 'emailOutboxDiagnostico', group: { label: 'Monitoreo', icon: 'pi pi-chart-bar' }, preview: 'admin-table', description: 'Gap asistencia-vs-correos y diagnóstico por correo específico' },
	...
	{ route: '/intranet/admin/rate-limit-events', label: 'Rate Limit', icon: 'pi pi-shield', permiso: PERMISOS.ADMIN_RATE_LIMIT_EVENTS, modulo: 'sistema', featureFlag: 'rateLimitMonitoring', group: { label: 'Monitoreo', icon: 'pi pi-chart-bar' }, preview: 'admin-table', description: 'Telemetría de rate limiting y respuestas 429' },
	{ route: '/intranet/admin/auditoria-correos', label: 'Auditoría de Correos', icon: 'pi pi-exclamation-triangle', permiso: PERMISOS.ADMIN_AUDITORIA_CORREOS, modulo: 'sistema', featureFlag: 'auditoriaCorreos', group: { label: 'Monitoreo', icon: 'pi pi-chart-bar' }, preview: 'admin-table', description: 'Correos activos con formato inválido' },
