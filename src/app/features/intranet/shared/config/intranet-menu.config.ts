...
export const MENU_ITEMS: MenuItemDef[] = [
	// --- Inicio ---
	{ route: '/intranet', label: 'Inicio', icon: 'pi pi-home', capability: 'INTRANET', modulo: 'inicio', exact: true, preview: 'home-dashboard', description: 'Página principal de la intranet' },
	...
	{ route: '/intranet/ayuda', label: 'Ayuda', icon: 'pi pi-question-circle', capability: 'INTRANET', modulo: 'inicio', preview: 'faq-tabs', description: 'Preguntas frecuentes, tickets y salud de tu sede' },

	// --- Estudiante ---
	{ route: '/intranet/estudiante/cursos', label: 'Mis Cursos', icon: 'pi pi-book', capability: 'CURSOS_ESTUDIANTE_PAGE_API_VIEW', modulo: 'estudiante', featureFlag: 'estudiante', group: { label: 'Mi Aula', icon: 'pi pi-graduation-cap' }, preview: 'course-cards', description: 'Contenido y materiales de tus cursos' },
	{ route: '/intranet/estudiante/salones', label: 'Mis Salones', icon: 'pi pi-building', capability: 'SALONES_ESTUDIANTE_PAGE_VIEW', modulo: 'estudiante', featureFlag: 'estudiante', group: { label: 'Mi Aula', icon: 'pi pi-graduation-cap' }, preview: 'salon-tabs', description: 'Ver tus salones asignados' },
	{ route: '/intranet/estudiante/horarios', label: 'Mi Horario', icon: 'pi pi-clock', capability: 'HORARIOS_ESTUDIANTE_PAGE_VIEW', modulo: 'estudiante', featureFlag: 'estudiante', group: { label: 'Mi Aula', icon: 'pi pi-graduation-cap' }, preview: 'week-schedule', description: 'Ver tu horario semanal de clases' },
	{ route: '/intranet/estudiante/notas', label: 'Mis Calificaciones', icon: 'pi pi-chart-bar', capability: 'CALIFICACIONES_ESTUDIANTE_PAGE_VIEW', modulo: 'estudiante', featureFlag: 'estudiante', group: { label: 'Mi Seguimiento', icon: 'pi pi-user' }, preview: 'grades', description: 'Consultar tus calificaciones' },
	{ route: '/intranet/estudiante/asistencia', label: 'Mi Asistencia', icon: 'pi pi-check-square', capability: 'ASISTENCIA_ESTUDIANTE_PAGE_VIEW', modulo: 'estudiante', featureFlag: 'estudiante', group: { label: 'Mi Seguimiento', icon: 'pi pi-user' }, preview: 'attendance', description: 'Revisar tu registro de asistencia' },
	{ route: '/intranet/estudiante/rendimiento', label: 'Mi Rendimiento', icon: 'pi pi-chart-line', capability: 'REPORTES_RENDIMIENTO', modulo: 'estudiante', featureFlag: 'estudiante', group: { label: 'Mi Seguimiento', icon: 'pi pi-user' }, description: 'Ver tu tendencia de rendimiento académico' },
	...
	{ route: '/intranet/estudiante/foro', label: 'Anuncios', icon: 'pi pi-comments', capability: 'FORO_ESTUDIANTE_PAGE_USE', modulo: 'estudiante', featureFlag: 'estudiante', group: { label: 'Mensajes', icon: 'pi pi-inbox' }, preview: 'forum', description: 'Ver publicaciones del profesor' },
	{ route: '/intranet/estudiante/mensajeria', label: 'Mensajería', icon: 'pi pi-envelope', capability: 'MENSAJERIA_ESTUDIANTE_PAGE_USE', modulo: 'estudiante', featureFlag: 'estudiante', group: { label: 'Mensajes', icon: 'pi pi-inbox' }, preview: 'messaging', description: 'Enviar y recibir mensajes' },
	...
	{ route: '/intranet/calendario', label: 'Calendario', icon: 'pi pi-calendar', capability: 'CALENDARIO_PAGE_USE', modulo: 'estudiante', featureFlag: 'calendario', soloParaRol: ['Estudiante'], preview: 'calendar', description: 'Calendario de eventos y actividades' },
	{ route: '/intranet/videoconferencias', label: 'Videoconferencias', icon: 'pi pi-video', capability: 'VIDEOCONFERENCIAS_PAGE_USE', modulo: 'estudiante', featureFlag: 'videoconferencias', soloParaRol: ['Estudiante'], preview: 'video-call', description: 'Salas de videoconferencia' },

	// --- Profesor ---
	{ route: '/intranet/profesor/cursos', label: 'Mis Cursos', icon: 'pi pi-book', capability: 'CURSOS_PROFESOR_PAGE_VIEW', modulo: 'profesor', featureFlag: 'profesor', group: { label: 'Mi Aula', icon: 'pi pi-graduation-cap' }, preview: 'course-cards', description: 'Contenido y materiales de tus cursos' },
	{ route: '/intranet/profesor/salones', label: 'Mis Salones', icon: 'pi pi-building', capability: 'SALONES_PROFESOR_PAGE_VIEW', modulo: 'profesor', featureFlag: 'profesor', group: { label: 'Mi Aula', icon: 'pi pi-graduation-cap' }, preview: 'salon-tabs', description: 'Ver los salones asignados' },
	{ route: '/intranet/profesor/horarios', label: 'Mi Horario', icon: 'pi pi-clock', capability: 'HORARIOS_PROFESOR_PAGE_VIEW', modulo: 'profesor', featureFlag: 'profesor', group: { label: 'Mi Aula', icon: 'pi pi-graduation-cap' }, preview: 'week-schedule', description: 'Ver tu horario semanal de clases' },
	{ route: '/intranet/profesor/calificaciones', label: 'Mis Calificaciones', icon: 'pi pi-chart-bar', capability: 'CALIFICACIONES_PROFESOR_PAGE_VIEW', modulo: 'profesor', featureFlag: 'profesor', group: { label: 'Mi Seguimiento', icon: 'pi pi-user' }, preview: 'grades', description: 'Registrar y consultar notas' },
	{ route: '/intranet/profesor/asistencia', label: 'Mi Asistencia', icon: 'pi pi-check-square', capability: 'ASISTENCIA_PROFESOR_PAGE_VIEW', modulo: 'profesor', featureFlag: 'profesor', group: { label: 'Mi Seguimiento', icon: 'pi pi-user' }, preview: 'attendance', description: 'Pasar lista de tus estudiantes' },
	...
	// Plan 101 F4 — misma ruta que la entrada admin de abajo (soloParaRol distingue), mismo
	// patrón de "múltiples entradas de menú → misma ruta" de AttendanceComponent (brief 559).
	{ route: '/intranet/justificacion-asistencia', label: 'Justificaciones', icon: 'pi pi-file-check', capability: 'JUSTIFICACION_ASISTENCIA_APROBAR', modulo: 'profesor', soloParaRol: ['Profesor'], featureFlag: 'profesor', group: { label: 'Mi Seguimiento', icon: 'pi pi-user' }, preview: 'admin-table', description: 'Aprobar o rechazar justificaciones de inasistencia de tus estudiantes' },
	// Brief 444: movido de "Mi Aula" (académico) a "Mi Seguimiento" — es actividad de seguimiento, no de estructura
	// Brief 507: renombrado de "Notas y Asistencia" a "Resumen de Salones" — colisionaba de nombre con "Mi Asistencia"
	// (ambos bajo "Mi Seguimiento"): esta es un dashboard resumen de todos los salones, "Mi Asistencia" es la acción de pasar lista.
	{ route: '/intranet/profesor/final-salones', label: 'Resumen de Salones', icon: 'pi pi-th-large', capability: 'SALONES_PROFESOR_FINAL_PAGE_VIEW', modulo: 'profesor', featureFlag: 'profesor', group: { label: 'Mi Seguimiento', icon: 'pi pi-user' }, preview: 'admin-table', description: 'Aprobación, asistencia y notas por salón' },
	{ route: '/intranet/profesor/foro', label: 'Foro', icon: 'pi pi-comments', capability: 'FORO_PROFESOR_PAGE_USE', modulo: 'profesor', featureFlag: 'profesor', group: { label: 'Mensajes', icon: 'pi pi-inbox' }, preview: 'forum', description: 'Participar en discusiones del aula' },
	{ route: '/intranet/profesor/mensajeria', label: 'Mensajería', icon: 'pi pi-envelope', capability: 'MENSAJERIA_PROFESOR_PAGE_USE', modulo: 'profesor', featureFlag: 'profesor', group: { label: 'Mensajes', icon: 'pi pi-inbox' }, preview: 'messaging', description: 'Enviar y recibir mensajes' },
	// Compartido (duplicado, ver §1 brief 444) — capability sin dueño de rol fijo, soloParaRol evita que otros roles con la misma capability disparen este módulo
	{ route: '/intranet/calendario', label: 'Calendario', icon: 'pi pi-calendar', capability: 'CALENDARIO_PAGE_USE', modulo: 'profesor', featureFlag: 'calendario', soloParaRol: ['Profesor'], preview: 'calendar', description: 'Calendario de eventos y actividades' },
	{ route: '/intranet/videoconferencias', label: 'Videoconferencias', icon: 'pi pi-video', capability: 'VIDEOCONFERENCIAS_PAGE_USE', modulo: 'profesor', featureFlag: 'videoconferencias', soloParaRol: ['Profesor'], preview: 'video-call', description: 'Salas de videoconferencia' },
	...
	{ route: '/intranet/admin/cursos', label: 'Cursos', icon: 'pi pi-book', capability: 'CURSOS_PAGE_VIEW', modulo: 'administrador', soloParaRol: ADMIN_ROLES, group: { label: 'Académico', icon: 'pi pi-graduation-cap' }, preview: 'admin-table', description: 'Administrar cursos y materias' },
	{ route: '/intranet/admin/salones', label: 'Salones', icon: 'pi pi-building', capability: 'SALONES_PAGE_VIEW', modulo: 'administrador', soloParaRol: ADMIN_ROLES, group: { label: 'Académico', icon: 'pi pi-graduation-cap' }, preview: 'salon-tabs', description: 'Gestionar aulas y secciones' },
	{ route: '/intranet/admin/horarios', label: 'Horarios', icon: 'pi pi-calendar', capability: 'HORARIOS_PAGE_VIEW', modulo: 'administrador', soloParaRol: ADMIN_ROLES, group: { label: 'Académico', icon: 'pi pi-graduation-cap' }, preview: 'admin-schedule', description: 'Configurar horarios escolares' },
	// Brief 495 (P91 F2) — capability de página nueva y separada de `REPORTES_RENDIMIENTO`
	...
	{ route: '/intranet/justificacion-asistencia', label: 'Justificaciones', icon: 'pi pi-file-check', capability: 'JUSTIFICACION_ASISTENCIA_APROBAR', modulo: 'administrador', soloParaRol: ADMIN_ROLES, group: { label: 'Asistencia', icon: 'pi pi-clock' }, subgroup: [{ label: 'Admin', icon: 'pi pi-cog' }], preview: 'admin-table', description: 'Bandeja de aprobación de justificaciones de inasistencia (Secundaria)' },
	...
	{ route: '/intranet/admin/explicaciones', label: 'Modo informativo', icon: 'pi pi-info-circle', capability: 'EXPLICACIONES_MANAGE', modulo: 'administrador', soloParaRol: ADMIN_ROLES, group: { label: 'Gestión', icon: 'pi pi-cog' }, preview: 'admin-table', description: 'Administrar el contenido explicativo del modo informativo' },
	...
	{ route: '/intranet/admin/monitoreo', label: 'Resumen', icon: 'pi pi-th-large', capability: 'MONITOREO_PAGE_VIEW', modulo: 'administrador', soloParaRol: ADMIN_ROLES, group: { label: 'Monitoreo', icon: 'pi pi-chart-bar' }, preview: 'hub-tiles', description: 'Hub de monitoreo: correos, incidencias y seguridad' },
	{ route: '/intranet/admin/monitoreo/correos/bandeja', label: 'Bandeja', icon: 'pi pi-inbox', capability: 'EMAIL_OUTBOX_API_VIEW', modulo: 'administrador', soloParaRol: ADMIN_ROLES, group: { label: 'Monitoreo', icon: 'pi pi-chart-bar' }, subgroup: [{ label: 'Correos', icon: 'pi pi-envelope' }], preview: 'admin-table', description: 'Trazabilidad completa del outbox: filtros por tipo, estado y rango — con HTML del cuerpo y exportación.' },
	{ route: '/intranet/admin/monitoreo/correos/dashboard', label: 'Dashboard del día', icon: 'pi pi-chart-bar', capability: 'EMAIL_OUTBOX_DASHBOARD_PAGE_VIEW', modulo: 'administrador', soloParaRol: ADMIN_ROLES, featureFlag: 'emailOutboxDashboardDia', group: { label: 'Monitoreo', icon: 'pi pi-chart-bar' }, subgroup: [{ label: 'Correos', icon: 'pi pi-envelope' }], preview: 'admin-table', description: 'Métricas en vivo: throttle, sender stats, dominios receptores y mapa de envío.' },
	{ route: '/intranet/admin/monitoreo/correos/diagnostico', label: 'Diagnóstico', icon: 'pi pi-search', capability: 'EMAIL_OUTBOX_DIAGNOSTICO_PAGE_API_VIEW', modulo: 'administrador', soloParaRol: ADMIN_ROLES, featureFlag: 'emailOutboxDiagnostico', group: { label: 'Monitoreo', icon: 'pi pi-chart-bar' }, subgroup: [{ label: 'Correos', icon: 'pi pi-envelope' }], preview: 'admin-table', description: 'Candidatos a blacklistear y dominios con tasa de fallo elevada.' },
	{ route: '/intranet/admin/monitoreo/correos/auditoria', label: 'Validación de datos', icon: 'pi pi-history', capability: 'AUDITORIA_CORREOS_API_VIEW', modulo: 'administrador', soloParaRol: ADMIN_ROLES, featureFlag: 'auditoriaCorreos', group: { label: 'Monitoreo', icon: 'pi pi-chart-bar' }, subgroup: [{ label: 'Correos', icon: 'pi pi-envelope' }], preview: 'admin-table', description: 'Registros con correo inválido o ausente.' },
	{ route: '/intranet/admin/monitoreo/correos/blacklist', label: 'Blacklist', icon: 'pi pi-ban', capability: 'EMAIL_BLACKLIST_API_MANAGE', modulo: 'administrador', soloParaRol: ADMIN_ROLES, featureFlag: 'emailBlacklistTab', group: { label: 'Monitoreo', icon: 'pi pi-chart-bar' }, subgroup: [{ label: 'Correos', icon: 'pi pi-envelope' }], preview: 'admin-table', description: 'Destinatarios bloqueados permanentemente, con motivo y fecha.' },
	{ route: '/intranet/admin/monitoreo/correos/quarantine', label: 'Cuarentena', icon: 'pi pi-clock', capability: 'EMAIL_QUARANTINE_API_MANAGE', modulo: 'administrador', soloParaRol: ADMIN_ROLES, featureFlag: 'emailQuarantineTab', group: { label: 'Monitoreo', icon: 'pi pi-chart-bar' }, subgroup: [{ label: 'Correos', icon: 'pi pi-envelope' }], preview: 'admin-table', description: 'Pausas temporales con auto-release. Promueve a blacklist al 3.er hit.' },
	{ route: '/intranet/admin/monitoreo/correos/domain-pauses', label: 'Dominios pausados', icon: 'pi pi-pause', capability: 'EMAIL_DOMINIO_PAGE_VIEW', modulo: 'administrador', soloParaRol: ADMIN_ROLES, featureFlag: 'emailDomainPausesTab', group: { label: 'Monitoreo', icon: 'pi pi-chart-bar' }, subgroup: [{ label: 'Correos', icon: 'pi pi-envelope' }], preview: 'admin-table', description: 'Dominios receptores pausados con timeout y auto-resume.' },
	{ route: '/intranet/admin/monitoreo/correos/defer-events', label: 'Eventos defer', icon: 'pi pi-replay', capability: 'EMAIL_DEFER_EVENTS_API_VIEW', modulo: 'administrador', soloParaRol: ADMIN_ROLES, featureFlag: 'emailDeferEventsTab', group: { label: 'Monitoreo', icon: 'pi pi-chart-bar' }, subgroup: [{ label: 'Correos', icon: 'pi pi-envelope' }], preview: 'admin-table', description: 'Historial de defers/fails sincrónicos del MTA por destinatario.' },
	{ route: '/intranet/admin/monitoreo/incidencias/errores', label: 'Errores', icon: 'pi pi-exclamation-circle', capability: 'ERROR_LOGS_API_VIEW', modulo: 'administrador', soloParaRol: ADMIN_ROLES, group: { label: 'Monitoreo', icon: 'pi pi-chart-bar' }, subgroup: [{ label: 'Incidencias', icon: 'pi pi-megaphone' }], preview: 'kanban', description: 'Bugs agrupados por fingerprint con kanban de estados (NUEVO → RESUELTO).' },
	{ route: '/intranet/admin/monitoreo/incidencias/reportes', label: 'Reportes de Usuarios', icon: 'pi pi-comment', capability: 'REPORTES_USUARIO_API_VIEW', modulo: 'administrador', soloParaRol: ADMIN_ROLES, group: { label: 'Monitoreo', icon: 'pi pi-chart-bar' }, subgroup: [{ label: 'Incidencias', icon: 'pi pi-megaphone' }], preview: 'admin-table', description: 'Feedback manual: tipo, descripción y propuesta enviada por usuarios.' },
	{ route: '/intranet/admin/monitoreo/seguridad/rate-limit', label: 'Rate Limit', icon: 'pi pi-bolt', capability: 'RATE_LIMIT_EVENTS_API_VIEW', modulo: 'administrador', soloParaRol: ADMIN_ROLES, featureFlag: 'rateLimitMonitoring', group: { label: 'Monitoreo', icon: 'pi pi-chart-bar' }, subgroup: [{ label: 'Seguridad', icon: 'pi pi-shield' }], preview: 'admin-table', description: 'Eventos 429 con policy, partition, top endpoints y top roles afectados.' },
	// Brief 444: grupo renombrado de "Monitoreo" a "Diagnóstico" — colisionaba de nombre con el ítem suelto "Monitoreo" de arriba.
	{ route: '/intranet/admin/sistema/runtime-health', label: 'Salud del runtime', icon: 'pi pi-server', capability: 'SISTEMA_RUNTIME_HEALTH_API_VIEW', modulo: 'administrador', soloParaRol: ADMIN_ROLES, featureFlag: 'runtimeHealth', group: { label: 'Diagnóstico', icon: 'pi pi-chart-bar' }, preview: 'system-metrics', description: 'Snapshot del runtime ASP.NET (ThreadPool, Requests, BD, GC)' },
	{ route: '/intranet/admin/sistema/db-diagnostics', label: 'Diagnóstico de BD', icon: 'pi pi-database', capability: 'SISTEMA_DB_DIAGNOSTICS_API_VIEW', modulo: 'administrador', soloParaRol: ADMIN_ROLES, featureFlag: 'dbDiagnostics', group: { label: 'Diagnóstico', icon: 'pi pi-chart-bar' }, preview: 'system-metrics', description: 'Uso de recursos, consultas costosas, bloqueos activos y almacenamiento del motor SQL' },
	...
	{ route: '/intranet/videoconferencias', label: 'Videoconferencias', icon: 'pi pi-video', capability: 'VIDEOCONFERENCIAS_PAGE_USE', modulo: 'administrador', soloParaRol: ADMIN_ROLES, featureFlag: 'videoconferencias', preview: 'video-call', description: 'Salas de videoconferencia' },
	...
	{ route: '/intranet/admin/cursos', label: 'Cursos', icon: 'pi pi-book', capability: 'CURSOS_PAGE_VIEW', modulo: 'apoderado', soloParaRol: ['Apoderado'], preview: 'admin-table', description: 'Ver los cursos disponibles' },
	{ route: '/intranet/admin/horarios', label: 'Horarios', icon: 'pi pi-calendar', capability: 'HORARIOS_PAGE_VIEW', modulo: 'apoderado', soloParaRol: ['Apoderado'], preview: 'admin-schedule', description: 'Consultar horario de clases' },
	{ route: '/intranet/admin/notificaciones', label: 'Notificaciones', icon: 'pi pi-bell', capability: 'NOTIFICACIONES_API_SEND', modulo: 'apoderado', soloParaRol: ['Apoderado'], preview: 'admin-notif', description: 'Avisos del colegio' },
	...
	{ route: '/intranet/calendario', label: 'Calendario', icon: 'pi pi-calendar', capability: 'CALENDARIO_PAGE_USE', modulo: 'apoderado', soloParaRol: ['Apoderado'], featureFlag: 'calendario', preview: 'calendar', description: 'Calendario de eventos y actividades' },
];
// #endregion
 ...
 * (ej. "Gestión" y "Reportes" comparten `ASISTENCIA_ADMIN_PAGE_VIEW`) y necesitan overrides
