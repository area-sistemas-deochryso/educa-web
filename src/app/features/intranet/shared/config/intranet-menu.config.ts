...
export const MENU_ITEMS: MenuItemDef[] = [
	...
	{ route: '/intranet/justificacion-asistencia', label: 'Justificaciones', icon: 'pi pi-file-check', capability: 'JUSTIFICACION_ASISTENCIA_API_APPROVE', modulo: 'profesor', soloParaRol: ['Profesor'], featureFlag: 'profesor', group: { label: 'Mi Seguimiento', icon: 'pi pi-user' }, preview: 'admin-table', description: 'Aprobar o rechazar justificaciones de inasistencia de tus estudiantes' },
